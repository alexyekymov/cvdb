<%@ page import="com.github.alexyekymov.cvdb.model.TextSection" %>
...
<%@ page import="com.github.alexyekymov.cvdb.util.HtmlUtil" %>
    ...
    <table cellpadding="2">
        <c:forEach var="sectionEntry" items="${resume.sections}">
            <jsp:useBean id="sectionEntry"
                         type="java.util.Map.Entry<com.github.alexyekymov.cvdb.model.SectionType,
                          com.github.alexyekymov.cvdb.model.Section>"/>
                ...
                <c:when test="${type=='EXPERIENCE' || type=='EDUCATION'}">
                    <c:forEach var="org" items="<%=((OrganizationSection)section).getOrganizations()%>">
                        ...
                        <c:forEach var="position" items="${org.positions}">
                            <jsp:useBean id="position" type="com.github.alexyekymov.cvdb.model.Organization.Position"/>
                            <tr>
